...
// node_modules/@toruslabs/tss-dkls-lib/dist/tssDklsLib.cjs.js
var require_tssDklsLib_cjs = __commonJS({
  "node_modules/@toruslabs/tss-dkls-lib/dist/tssDklsLib.cjs.js"(exports, module) {
    (() => {
      "use strict";
      ...
      var dkls_namespaceObject = {};
      __webpack_require__.r(dkls_namespaceObject);
      __webpack_require__.d(dkls_namespaceObject, {
        batch_size: () => batch_size,
        "default": () => dkls,
        get_r_from_precompute: () => get_r_from_precompute,
        initSync: () => initSync,
        local_sign: () => local_sign,
        local_verify: () => local_verify,
        precompute: () => precompute,
        random_generator: () => random_generator,
        random_generator_free: () => random_generator_free,
        setup: () => setup,
        sign: () => sign,
        threshold_signer: () => threshold_signer,
        threshold_signer_free: () => threshold_signer_free
      });
      ;
      let wasm;
...
${val.stack}`;
      ...
      function local_sign(msg, hash_only, precompute2) {
        try {
          const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
          const ptr0 = passStringToWasm0(msg, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
          const len0 = WASM_VECTOR_LEN;
          wasm.local_sign(retptr, ptr0, len0, hash_only, addHeapObject(precompute2));
          var r0 = getInt32Memory0()[retptr / 4 + 0];
          var r1 = getInt32Memory0()[retptr / 4 + 1];
          var r2 = getInt32Memory0()[retptr / 4 + 2];
          if (r2) {
      ...
      function get_r_from_precompute(precompute2) {
        try {
          const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
          wasm.get_r_from_precompute(retptr, addHeapObject(precompute2));
          var r0 = getInt32Memory0()[retptr / 4 + 0];
          var r1 = getInt32Memory0()[retptr / 4 + 1];
          var r2 = getInt32Memory0()[retptr / 4 + 2];
          if (r2) {
        ...
        imports.wbg.__wbg_new_9962f939219f1820 = function(arg0, arg1) {
          try {
            ...
            var cb0 = (arg02, arg12) => {
              ...
              state0.a = 0;
              try {
                return __wbg_adapter_36(a, state0.b, arg02, arg12);
              } finally {
                state0.a = a;
              }
            };
...
export default require_tssDklsLib_cjs();
//# sourceMappingURL=@toruslabs_tss-dkls-lib.js.map
