...
function validateVersion(version, allowedVersions) {
  if (!Object.keys(ethereumProvider.SignTypedDataVersion).includes(version)) {
...
function getProviderHandlers({
  ...
  return {
    ...
    processTypedMessageV4: async (msgParams, _) => {
      ...
      await ethereumProvider.validateTypedSignMessageDataV4(msgParams, chainId);
      const data = typeof msgParams.data === "string" ? JSON.parse(msgParams.data) : msgParams.data;
      const sig = signTypedData(sign, data, ethereumProvider.SignTypedDataVersion.V4);
      return sig;
    }
  };
}
